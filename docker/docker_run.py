...
if __name__=="__main__":
    ...
    default_image_name = '{}-pointnet'.format(user_name)
    parser = argparse.ArgumentParser()
    parser.add_argument("-i", "--image", type=str,
        help="(required) name of the image that this container is derived from", default=default_image_name)

    parser.add_argument("-c", "--container", type=str, default="pointnet-container-{}".format(user_name), help="(optional) name of the container")\
